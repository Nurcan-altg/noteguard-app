            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  ...
                  />
                  <label htmlFor="remember-me" className={`ml-2 block ${generateTailwindClasses.text.sm} ${generateTailwindClasses.textPrimary}`}>
                    Beni hatırla
                  </label>
                </div>

                <div className={generateTailwindClasses.text.sm}>
                  <Link
                    to="/forgot-password"
                    className={`${generateTailwindClasses.font.semibold} text-indigo-600 hover:text-indigo-500 transition-colors duration-300`}
                  >
